...
public class ControlQuiz {
		...
		public static void main(String[] args) {
			...
			/*3. 조건문 if를 사용하여 x,y를 동등비교, 크다 비교와 기타(아닌것)로 비교(if~else , if ~ else)
			...
			/*
			 * 4. int 변수 time은 20 조건연산자(삼항연산자)를 이용해 time이 18보다 적으면 Good day를, 아니면 Good
			 * Evening를 선택하여 result변수에 저장 , result 출력
			 */
			
			int time = 20;
			String Goodday, GoodEvening;
			String result = " ";
